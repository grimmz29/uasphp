...
<html>
	...
	<body>
		...
		<h1><center>List Anggota</center></h1>
		<br>
			<center><form name="form" action="fungsiaddkelas.php" method="post">
				...
				?>
						<tr>
							...
							<td><?=$row['jabatan'];?></td>
							<td><?=$row['foto'];?></td>
							<td align="center"><a href= "editanggota.php?id_anggota=<?php print($row['nim']) ?>" > Edit</a>
								&nbsp;&nbsp;<a href= "deleteanggota.php?id_anggota=<?php print($row['nim']) ?>" > Hapus</a>
							</td>
					<?php
					}
					?>
