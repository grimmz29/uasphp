...
<html>
	...
	<body>
		...
		<h1><center>Tambah Jabatan</center></h1><br>
		<?php
			$jabatan = $_GET['id_jabatan'];
			$query2 = mysqli_query($conn, "select * from jabatan where id_jabatan='$jabatan'");
			$row2 = mysqli_fetch_array($query2);
		?>
		<center><form name="form" action="fungsieditjabatan.php?id_jabatan=<?php print($jabatan); ?>" method="post" enctype="multipart/form-data">
			<table width="500" height="300" border="0">
				<tr>
					<td>Nama Jabatan</td>
					<td>
						<input type="text" name="nm_jabatan" value="<?php print($row2['nm_jabatan']); ?>" id="nm_jabatan" size="30" maxlength="50" />
					</td>
				</tr>
