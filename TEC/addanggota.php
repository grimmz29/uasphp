...
<html>
	...
	<body>
		...
		<center><form name="form" action="fungsiaddanggota.php" method="post" enctype="multipart/form-data">
			<table width="500" height="300" border="0">
				<tr>
					<td>Nama</td>
					<td>
						<input type="text" name="nama" id="nama" size="30" maxlength="50" />
					</td>
				</tr>
				<tr>
					<td>NIM</td>
					<td>
					  <input type="text" name="nim" id="nim" size="30" maxlength="20" />
					</td>
				</tr> 
				<tr>
					<td>Jabatan</td>
