...
<html>
	...
	<body>
		...
		<center><form name="form" action="fungsiaddprofiltec.php" method="post" enctype="multipart/form-data">
			<table width="500" height="300" border="0">
				<tr>
					<td>Profile</td>
					<td>
						<textarea name="profiltec" id="profiltec" cols="40" rows="8"></textarea>
					</td>
				</tr>
				<tr>
					<td>Vision</td>
					<td>
					  <textarea name="vision" id="vision" cols="40" rows="8"></textarea>
					</td>
				</tr> 
				<tr>
					<td>Mission</td>
					<td>
						<textarea name="mission" id="mission" cols="40" rows="8"></textarea>
					</td>
				</tr>
				<tr>
