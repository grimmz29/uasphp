...
<html>
	...
	<body>
		...
		<h1><center>List Kelas</center></h1>
		<br>
			<center>
				...
				?>
						<tr>
							<td><?=$row['nama'];?></td>
							<td><?=$row['des_pendek'];?></td>
							<td><?=$row['des_lengkap'];?></td>
							<td><?=$row['guru'];?></td>
							<td><?=$row['tanggal'];?></td>
							<td><?=$row['jam'];?></td>
							<td align="center"><a href= "editkelas.php?id_kelas=<?php print($row['id_kelas']) ?>" > Edit</a>
								&nbsp;&nbsp;<a href= "deletekelas.php?id_kelas=<?php print($row['id_kelas']) ?>" > Hapus</a>
							</td>
					<?php
					}
					?>
